...
function Home() {
  ...
  return (
    ...
    <div>
    <h1 className='font-extrabold text-white text-[32px]'> معرض الصور التي انشأها المستخدمون</h1>
    <p className='mt-2 text-[#666e75] text-[14px] max-w-[650px]'>تصفح مجموعة من الصور المذهلة بصريا التي تم إنشاؤها بواسطة DALL-E الذكاء الاصطناعي</p>
    </div>
    <div className="mt-16">
        <FormField
          labelName=""
